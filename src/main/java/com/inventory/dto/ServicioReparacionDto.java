...
public class ServicioReparacionDto {
    ...
    private List<ServicioReparacionProductoDto> productos = new ArrayList<>();
    
    // Constructores
    public ServicioReparacionDto() {
    }
    
    public ServicioReparacionDto(String id, String clienteId, Long electrodomesticoId, 
                                  String tipoServicio, String estado, BigDecimal totalCosto, 
    ...
    public Long getElectrodomesticoId() {
        return electrodomesticoId;
    }
    
    public void setElectrodomesticoId(Long electrodomesticoId) {
        this.electrodomesticoId = electrodomesticoId;
    }
    ...
    public String getElectrodomesticoMarca() {
        return electrodomesticoMarca;
    }
    
    public void setElectrodomesticoMarca(String electrodomesticoMarca) {
        this.electrodomesticoMarca = electrodomesticoMarca;
    }
    ...
    public String getTecnicoAsignadoUsername() {
        return tecnicoAsignadoUsername;
    }

    public void setTecnicoAsignadoUsername(String tecnicoAsignadoUsername) {
        this.tecnicoAsignadoUsername = tecnicoAsignadoUsername;
    }
    ...
    public List<ServicioReparacionProductoDto> getProductos() {
        return productos;
    }

    public void setProductos(List<ServicioReparacionProductoDto> productos) {
        this.productos = productos;
    }
    
    @Override
    public String toString() {
        return "ServicioReparacionDto{" +
                "id=" + id +
